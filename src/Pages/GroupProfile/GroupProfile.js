...
const handleGroupSummaryPost = () => {
  ...
  fetch(`http://18.211.204.106/post/${groupId.groupId}/group-summery-create/`, {
    method: "POST",
    headers: {
 ...
 const handleGroupThoughtPost = () => {
  ...
  fetch(`http://18.211.204.106/post/${groupId.groupId}/group-thought-create/`, {
    method: "POST",
    headers: {
      "Authorization" : `Token ${localStorage.getItem('auth_token')}`,
    },
...
useEffect(() => {
  fetch(`http://18.211.204.106/post/${groupId.groupId}/group-summery-all`, {
  method: 'GET',
  headers: {
      "Authorization" : `Token ${localStorage.getItem('auth_token')}`,
...
useEffect(() => {
  fetch(`http://18.211.204.106/post/${groupId.groupId}/group-thought-all`, {
  method: 'GET',
  headers: {
      "Authorization" : `Token ${localStorage.getItem('auth_token')}`,
      "Accept": "application/json",
...
// getting group member info
  useEffect(() => {
    fetch(`http://18.211.204.106/group/${groupId.groupId}/${userId}/member-detail/`, {
    method: 'GET',
    headers: {
        "Authorization" : `Token ${localStorage.getItem('auth_token')}`,
        "Accept": "application/json",
  ...
  useEffect(() => {
    fetch(`http://18.211.204.106/group/${groupId.groupId}/all-criteria/`, {
    method: 'GET',
    headers: {
        "Authorization" : `Token ${localStorage.getItem('auth_token')}`,
        "Accept": "application/json",
...
useEffect(() => {
  fetch(`http://18.211.204.106/course/group/${groupId.groupId}/group-courses/`, {
  method: 'GET',
  headers: {
      "Authorization" : `Token ${localStorage.getItem('auth_token')}`,
      "Accept": "application/json",
  ...
  .then(data => {
    ...
    const updateGroup = (e) =>{
        ...
        fetch(`http://18.211.204.106/group/${groupId.groupId}/group-update/`, updateGroupHeader)
  ...
  const groupCriteriaPost = (e) =>{
      ...
      fetch(`http://18.211.204.106/group/${groupId.groupId}/add-criteria/`, groupCriteriaPostHeader)
          .then(response => {response.json()
...
const updateGroupNameFunction = () =>{
  ...
  fetch(`http://18.211.204.106/group/${groupId.groupId}/group-update/`, updateGroupNameHeader)
      .then(response => {response.json()
            if (response.status===200) {

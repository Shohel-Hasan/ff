...
const SingleCourse = (props) => {
    ...
    const submitHandler = (event) => {
      ...
      fetch(`http://18.211.204.106/course/${courseId.courseId}/enrollment/course-enrollment-payment/`, header)
    ...
    //   ------ Course Admin check --------  //
    useEffect(() =>{
      fetch(`http://18.211.204.106/course/${courseId.courseId}/staff/single-staff`, {
        method: 'GET',
        headers: {
            "Authorization" : `Token ${localStorage.getItem('auth_token')}`,
            "Accept": "application/json",
  ...
  useEffect(() =>{
    fetch(`http://18.211.204.106/course/${courseId.courseId}/enrollment/${localStorage.getItem('id')}`, {
      method: 'GET',
      headers: {
          "Authorization" : `Token ${localStorage.getItem('auth_token')}`,
          "Accept": "application/json",
  ...
  //   ------ Enrolled students--------  //
  useEffect(() =>{
    fetch(`http://18.211.204.106/course/${courseId.courseId}/enrollment/payment-all`, {
      method: 'GET',
      headers: {
          "Authorization" : `Token ${localStorage.getItem('auth_token')}`,
          "Accept": "application/json",
   ...
   useEffect(() =>{
    fetch(`http://18.211.204.106/course/${courseId.courseId}/class-link-detail`, {
      method: 'GET',
      headers: {
          "Authorization" : `Token ${localStorage.getItem('auth_token')}`,
          "Accept": "application/json",
...
//   ------ Single course details --------  //
    useEffect(() =>{
        fetch(`http://18.211.204.106/course/single-course/${courseId.courseId}`, {
          method: 'GET',
          headers: {
              "Authorization" : `Token ${localStorage.getItem('auth_token')}`,
              "Accept": "application/json",
    ...
    useEffect(() =>{
      fetch(`http://18.211.204.106/course/${courseId.courseId}/class-routine`, {
        method: 'GET',
        headers: {
            "Authorization" : `Token ${localStorage.getItem('auth_token')}`,
            "Accept": "application/json",
    ...
    const courseClassLinkCreate = (e) =>{
      ...
      fetch(`http://18.211.204.106/course/${courseId.courseId}/class-link-create/`, courseClassLinkHeader)
          .then(response => {response.json()
    ...
    const courseNoticeCreate = (e) =>{
      ...
      fetch(`http://18.211.204.106/course/${courseId.courseId}/notice/create/`, courseNoticeHeader)
          .then(response => {response.json()
              if (response.status===201) {
  ...
  useEffect(() =>{
    fetch(`http://18.211.204.106/course/${courseId.courseId}/notice/all/`, {
      method: 'GET',
      headers: {
          "Authorization" : `Token ${localStorage.getItem('auth_token')}`,
          "Accept": "application/json",
    ...
    const courseClassLinkUpdate = (e) =>{
      ...
      fetch(`http://18.211.204.106/course/${courseId.courseId}/class-link-detail/`, courseClassLinkUpdateHeader)
          .then(response => response.json())
          .then(data=>{
            console.log(data)

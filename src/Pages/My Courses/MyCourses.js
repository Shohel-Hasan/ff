    ...
    <div>
      <Container className='my_course_container'>
       <Row className='justify-content-center align-items-center'>
          {userGeneralInfo.cover_pic!==null && <img style={{ borderBottomRightRadius:'8px', borderBottomLeftRadius:'8px', objectFit: 'cover', width:'850px', height:'320px' }} className='' src={`${BASE_URL}${userGeneralInfo.cover_pic}`} alt='Cover'/>}
          {userGeneralInfo.cover_pic===null && <img style={{ borderBottomRightRadius:'8px', borderBottomLeftRadius:'8px', objectFit: 'cover', width:'850px', height:'320px' }} className='' src={img} alt='Cover'/>}
